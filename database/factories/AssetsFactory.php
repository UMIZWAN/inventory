...
class AssetsFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'asset_tag' => $this->faker->randomElement(['Delivery Gift', 'Insurance Gift', 'Test Drive Gift', 'Doorgift', 'Vip Gift', 'Premium Gift', 'Event Gift', 'Booking Gift', 'Customer Visit Gift', 'Others', null]),
