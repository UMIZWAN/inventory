...
const EditAccessLevelModal = ({ isOpen, onClose, accessLevel, onAccessLevelUpdated }) => {
    ...
    useEffect(() => {
        if (accessLevel) {
            setFormData({
                ...
                view_transaction: accessLevel.view_transaction || false,
                approve_reject_transaction: accessLevel.approve_reject_transaction || false,
                receive_transaction: accessLevel.receive_transaction || false,
                add_edit_purchase_order: accessLevel.add_edit_purchase_order || false,
                view_purchase_order: accessLevel.view_purchase_order || false,
                add_edit_supplier: accessLevel.add_edit_supplier || false,
                view_supplier: accessLevel.view_supplier || false,
                add_edit_tax: accessLevel.add_edit_tax || false,
                view_tax: accessLevel.view_tax || false,
                view_reports: accessLevel.view_reports || false,
                download_reports: accessLevel.download_reports || false,
            });
        }
    }, [accessLevel]);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (error.response && error.response.data && error.response.data.errors) {
                ...
                setErrors({ general: 'An error occurred while updating the access level.' });
            }
        } finally {
            setLoading(false);
        }
        ...
        <div className="fixed inset-0 bg-gray-600/70 overflow-y-auto h-full w-full z-50">
            <div className="relative top-20 mx-auto p-5 border w-full max-w-md shadow-lg rounded-md bg-white">
                <div className="flex justify-between items-center mb-4">
                    <h3 className="text-lg font-medium">Edit Access Level</h3>
                    <button
                        onClick={onClose}
